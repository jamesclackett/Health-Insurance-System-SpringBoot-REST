...
The aim of this project was to showcase the use SpringBoot for creating distributed RESTful services. _Please also see my similar <a href="https://github.com/jamesclackett/Health-Insurance-System-JMS" target="_blank">JMS repository</a>
 which showcases the use of Java Message Service for creating distributed services._
